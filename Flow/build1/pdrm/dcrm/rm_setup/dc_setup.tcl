...
set RTL_SOURCE_FILES  "digital_top.v analog_sanitizer.v counter.v spi_slave.v state_machine.v sync_and_filter.v"      ;# Enter the list of source RTL files if reading from RTL
