...
set TECH_FILE 			"${TECH_HOME}/dk_open/local/icc2libprep/gf180mcu_fd_sc_mcu7t5v0/gf180nm_mcu_5LM_1TM_11K_7t_mw.tf" 	;# A technology file; TECH_FILE and TECH_LIB are mutually exclusive ways to specify technology information; 
...
set ROUTING_LAYER_DIRECTION_OFFSET_LIST " \
  {Metal1 horizontal 0.0} \
  {Metal2 vertical 0.0} \
  {Metal3 horizontal 0.0} \
  {Metal4 vertical 0.0} \
  {Metal5 horizontal 0.0} \
"
...
set MAX_ROUTING_LAYER		"Metal5"	;# Max routing layer name; normally should be specified; otherwise tool can use all metal layers
